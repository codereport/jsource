...
ops =: (0$0);(0$'a');(0$4);(0$1.5);(0$1j1);(0$a:);(0$4r6);(0$u:'a');(0$10 u:'a')
ops =: ops , (0 1$0);(1 0$'a');(0 2$4);(2 0$1.5);(0 1 3$a:);(1 0 4$4r6);(4 0 5$u:'a');(0 5 0$10 u:'a')
ops =: ops , (0);(1$'a');(2$4);(2 1$1.5);(2$1j1);(3$a:);(2$4r6);(1 2 3$u:'a');(3$10 u:'a')
y =: <@(ops {~ (#ops) ?@$~ ])"0 ] 2 + 1000000 ?@$ 3
(> etx -: >"0 etx)@> y
NB. Test with different shapes/types of nonempty
ops =: (0);('a');(4);(1.5);(1j1);(a:);(4r6);(u:'a');(10 u:'a')
