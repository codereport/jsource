...
f&>/~ 0 1;(i.100);(1e7*i.100);(0.1*i.100);((j. |.) i. 100);(i. 100); (i. 100) % 2
(0 1;(i.100);1e7*i.100) f&>/ (,  ( ; 4r7&+)@(1&{::) (,<) ^@o.@j.@(2&{::)) (<200 2) ?@$&.> 2 2e9 0
