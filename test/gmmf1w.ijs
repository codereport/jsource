1:@:(dbr bind Debug)@:(9!:19)2^_44[(echo^:ECHOFILENAME) './gmmf1w.ijs'
...
t=: u:'testing testing 1 2 3'  
t fwrite f0
t -: 6&u: fread f0

JCHAR2 map_jmf_ 'abc';f0     NB. map abc to file characters
abc -: t
abc=: |.abc
abc -: |. t
...
1 [ createjmf_jmf_ f,<2000  NB. 2000 bytes for data
t=: fdir f
1 = #t
...
jdata=: 1000$u:'abcd'
'allocation error' -: ex 'jdata=: 1001$u:''zxcv'''  NB. too much data for file
...
x=: u:'Professors in New England guard the glory that was Greece'
x fwrite f
JCHAR2 map_jmf_ 'jdata';f
jdata -: x
0 -: unmap_jmf_ 'jdata'
