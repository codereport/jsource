1:@:(dbr bind Debug)@:(9!:19)2^_44[(echo^:ECHOFILENAME) './g9x40.ijs'
NB. 9!:40 and 9!:41 -----------------------------------------------------
...
NB. E. #broken
NB. x=: (i{.t),(2+i)}.t [ i=: ('  :' E. t)i.1

NB. (5!:1 <'f') -: < (,':');<(nn 3),nn ];._2 x
NB. (5!:2 <'f') -: 3;(,':');];._2 x
NB. (5!:5 <'f') -: '3 : 0',lf,x,')'
...
NB. E. broken
NB. x=: (i{.t),(3+i)}.t [ i=: ('   :' E. t)i.1

NB. (5!:1 <'f') -: < (,':');<(nn 1),nn ];._2 x
NB. (5!:2 <'f') -: 1;(,':');];._2 x
NB. (5!:5 <'f') -: '1 : 0',lf,x,')'
