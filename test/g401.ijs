1:@:(dbr bind Debug)@:(9!:19)2^_44[(echo^:ECHOFILENAME) './g401.ijs'
NB. #.y -----------------------------------------------------------------
...
(_3r2+2^n+1) = 2 #. (n$1),1r2 [ n=: 30
(_3r2+2^n+1) = 2 #. (n$1),1r2 [ n=: 34
(_3r2+2^n+1) = 2 #. (n$1),1r2 [ n=: 62
(_3r2+2^n+1) = 2 #. (n$1),1r2 [ n=: 66
