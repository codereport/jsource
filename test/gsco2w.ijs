1:@:(dbr bind Debug)@:(9!:19)2^_44[(echo^:ECHOFILENAME) './gsco2w.ijs'
NB. s: unicode ------------------------------------------------------------------

NB. create test data set 

x=: s: (u: 128+a.i. 'wxyz'),&.>/":&.>?20$123
y=: s: (u: 128+a.i. 'abcd'),&.>/":&.>?20$110
a=: {. s: u:' 4'

t=: (u:&.>) ;:'anaphoric chthonic metonymic oxymoronic sardonic'
u=: ~. s: , t ,&.>/":&.>":&.>?10$50
v=: /:/: u
