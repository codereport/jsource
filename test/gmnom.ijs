1:@:(dbr bind Debug)@:(9!:19)2^_44[(echo^:ECHOFILENAME) './gmnom.ijs'
...
(<x=:?5 2$2) (p1 -: p.) y=: _7+?2 1 4$13
(<x=:?5 2$2) (p1 -: p.) y=: %/y+0=y=:_7+?2 3 4$13
...
(<x=:?5 2$10 6) (p1 -: p.) y=: _7+?2 1 4$13
(<x=:?5 2$10 6) (p1 -: p.) y=: %/y+0=y=:_7+?2 3 4$13
...
(<x=:j./?2 5 2$10 6) (p1 -: p.) y=: _7+?2 1 4$13
(<x=:j./?2 5 2$10 6) (p1 -: p.) y=: %/y+0=y=:_7+?2 3 4$13

NB. rational

(<x=:1r2 0+"1?5 2$10 6) (p1 -: p.) y=: ?7$2
(<x=:1r2 0+"1?5 2$10 6) (p1 -: p.) y=: _7+?2 3 4$13
(<x=:1r2 0+"1?5 2$10 6) (p1 -: p.) y=: o._7+?3 4$13
(<x=:1r2 0+"1?5 2$10 6) (p1 -: p.) y=: r._7+?2 1 4$13
(<x=:1r2 0+"1?5 2$10 6) (p1 -: p.) y=: _7+?2 1 4$13
(<x=:1r2 0+"1?5 2$10 6) (p1 -: p.) y=: %/y+0=y=:_7+?2 3 4$13
...
(<x=:?5 4$2) (pn -: p.) y=: <"1 _7+?2 1 3$13
(<x=:?5 4$2) (pn -: p.) y=: <"1 %/y+0=y=:_7+?2 3 3$13
...
(<x=:?5 4$20 4 4 4) (pn -: p.) y=: <"1 _7+?2 1 3$13
(<x=:?5 4$20 4 4 4) (pn -: p.) y=: <"1 %/y+0=y=:_7+?2 3 3$13
...
(<x=:j./?2 5 4$20 4 4 4) (pn -: p.) y=: <"1 _7+?2 1 3$13
(<x=:j./?2 5 4$20 4 4 4) (pn -: p.) y=: <"1 %/y+0=y=:_7+?2 3 3$13
...
(<x=:1r2 0 0 0+"1?5 4$20 4 4 4) (pn -: p.) y=: <"1 _7+?2 1 3$13
(<x=:1r2 0 0 0+"1?5 4$20 4 4 4) (pn -: p.) y=: <"1 %/y+0=y=:_7+?2 3 3$13
