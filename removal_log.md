...
|`jsrc\adverbs\a.c`|from|jtfrom|`(^\|[ \t]+\|[^\d\w_])from\((?=([^,]+?),([^)]+?)\))`|`\1jtfrom(jt,`|
|`jsrc\adverbs\ab.c`|from|jtfrom|`(^\|[ \t]+\|[^\d\w_])from\((?=([^,]+?),([^)]+?)\))`|`\1jtfrom(jt,`|
|`jsrc\adverbs\am.c`|from|jtfrom|`(^\|[ \t]+\|[^\d\w_])from\((?=([^,]+?),([^)]+?)\))`|`\1jtfrom(jt,`|
|`jsrc\adverbs\am1.c`|from|jtfrom|`(^\|[ \t]+\|[^\d\w_])from\((?=([^,]+?),([^)]+?)\))`|`\1jtfrom(jt,`|
|`jsrc\adverbs\amn.c`|from|jtfrom|`(^\|[ \t]+\|[^\d\w_])from\((?=([^,]+?),([^)]+?)\))`|`\1jtfrom(jt,`|
|`jsrc\adverbs\ao.c`|from|jtfrom|`(^\|[ \t]+\|[^\d\w_])from\((?=([^,]+?),([^)]+?)\))`|`\1jtfrom(jt,`|
|`jsrc\adverbs\ap.c`|from|jtfrom|`(^\|[ \t]+\|[^\d\w_])from\((?=([^,]+?),([^)]+?)\))`|`\1jtfrom(jt,`|
|`jsrc\adverbs\ar.c`|from|jtfrom|`(^\|[ \t]+\|[^\d\w_])from\((?=([^,]+?),([^)]+?)\))`|`\1jtfrom(jt,`|
|`jsrc\adverbs\as.c`|from|jtfrom|`(^\|[ \t]+\|[^\d\w_])from\((?=([^,]+?),([^)]+?)\))`|`\1jtfrom(jt,`|
|`jsrc\conjunctions\cc.c`|from|jtfrom|`(^\|[ \t]+\|[^\d\w_])from\((?=([^,]+?),([^)]+?)\))`|`\1jtfrom(jt,`|
|`jsrc\conjunctions\cg.c`|from|jtfrom|`(^\|[ \t]+\|[^\d\w_])from\((?=([^,]+?),([^)]+?)\))`|`\1jtfrom(jt,`|
|`jsrc\conjunctions\ch.c`|from|jtfrom|`(^\|[ \t]+\|[^\d\w_])from\((?=([^,]+?),([^)]+?)\))`|`\1jtfrom(jt,`|
|`jsrc\conjunctions\cp.c`|from|jtfrom|`(^\|[ \t]+\|[^\d\w_])from\((?=([^,]+?),([^)]+?)\))`|`\1jtfrom(jt,`|
|`jsrc\conjunctions\cpdtsp.c`|from|jtfrom|`(^\|[ \t]+\|[^\d\w_])from\((?=([^,]+?),([^)]+?)\))`|`\1jtfrom(jt,`|
|`jsrc\conjunctions\crs.c`|from|jtfrom|`(^\|[ \t]+\|[^\d\w_])from\((?=([^,]+?),([^)]+?)\))`|`\1jtfrom(jt,`|
|`jsrc\conjunctions\cu.c`|from|jtfrom|`(^\|[ \t]+\|[^\d\w_])from\((?=([^,]+?),([^)]+?)\))`|`\1jtfrom(jt,`|
|`jsrc\conjunctions\cx.c`|from|jtfrom|`(^\|[ \t]+\|[^\d\w_])from\((?=([^,]+?),([^)]+?)\))`|`\1jtfrom(jt,`|
|`jsrc\debugging\dc.c`|from|jtfrom|`(^\|[ \t]+\|[^\d\w_])from\((?=([^,]+?),([^)]+?)\))`|`\1jtfrom(jt,`|
|`jsrc\parsing\p.c`|from|jtfrom|`(^\|[ \t]+\|[^\d\w_])from\((?=([^,]+?),([^)]+?)\))`|`\1jtfrom(jt,`|
|`jsrc\representations\rl.c`|from|jtfrom|`(^\|[ \t]+\|[^\d\w_])from\((?=([^,]+?),([^)]+?)\))`|`\1jtfrom(jt,`|
|`jsrc\verbs\v.c`|from|jtfrom|`(^\|[ \t]+\|[^\d\w_])from\((?=([^,]+?),([^)]+?)\))`|`\1jtfrom(jt,`|
|`jsrc\verbs\v0.c`|from|jtfrom|`(^\|[ \t]+\|[^\d\w_])from\((?=([^,]+?),([^)]+?)\))`|`\1jtfrom(jt,`|
|`jsrc\verbs\v1.c`|from|jtfrom|`(^\|[ \t]+\|[^\d\w_])from\((?=([^,]+?),([^)]+?)\))`|`\1jtfrom(jt,`|
|`jsrc\verbs\v2.c`|from|jtfrom|`(^\|[ \t]+\|[^\d\w_])from\((?=([^,]+?),([^)]+?)\))`|`\1jtfrom(jt,`|
|`jsrc\verbs\vcant.c`|from|jtfrom|`(^\|[ \t]+\|[^\d\w_])from\((?=([^,]+?),([^)]+?)\))`|`\1jtfrom(jt,`|
|`jsrc\verbs\vcat.c`|from|jtfrom|`(^\|[ \t]+\|[^\d\w_])from\((?=([^,]+?),([^)]+?)\))`|`\1jtfrom(jt,`|
|`jsrc\verbs\vf.c`|from|jtfrom|`(^\|[ \t]+\|[^\d\w_])from\((?=([^,]+?),([^)]+?)\))`|`\1jtfrom(jt,`|
|`jsrc\verbs\vfrom.c`|from|jtfrom|`(^\|[ \t]+\|[^\d\w_])from\((?=([^,]+?),([^)]+?)\))`|`\1jtfrom(jt,`|
|`jsrc\verbs\vg.c`|from|jtfrom|`(^\|[ \t]+\|[^\d\w_])from\((?=([^,]+?),([^)]+?)\))`|`\1jtfrom(jt,`|
|`jsrc\verbs\vgsp.c`|from|jtfrom|`(^\|[ \t]+\|[^\d\w_])from\((?=([^,]+?),([^)]+?)\))`|`\1jtfrom(jt,`|
|`jsrc\verbs\vp.c`|from|jtfrom|`(^\|[ \t]+\|[^\d\w_])from\((?=([^,]+?),([^)]+?)\))`|`\1jtfrom(jt,`|
|`jsrc\verbs\vrep.c`|from|jtfrom|`(^\|[ \t]+\|[^\d\w_])from\((?=([^,]+?),([^)]+?)\))`|`\1jtfrom(jt,`|
