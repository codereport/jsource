...
|`jsrc\k.c`|ext|jtext|`(^\|[ \t]+\|[^\d\w_])ext\((?=([^,]+?),([^)]+?)\))`|`\1jtext(jt,`|
|`jsrc\s.h`|ext|jtext|`(^\|[ \t]+\|[^\d\w_])ext\((?=([^,]+?),([^)]+?)\))`|`\1jtext(jt,`|
|`jsrc\sn.c`|ext|jtext|`(^\|[ \t]+\|[^\d\w_])ext\((?=([^,]+?),([^)]+?)\))`|`\1jtext(jt,`|
|`jsrc\conjunctions\cl.c`|ext|jtext|`(^\|[ \t]+\|[^\d\w_])ext\((?=([^,]+?),([^)]+?)\))`|`\1jtext(jt,`|
|`jsrc\conjunctions\cp.c`|ext|jtext|`(^\|[ \t]+\|[^\d\w_])ext\((?=([^,]+?),([^)]+?)\))`|`\1jtext(jt,`|
|`jsrc\conjunctions\cpdtsp.c`|ext|jtext|`(^\|[ \t]+\|[^\d\w_])ext\((?=([^,]+?),([^)]+?)\))`|`\1jtext(jt,`|
|`jsrc\conjunctions\cx.c`|ext|jtext|`(^\|[ \t]+\|[^\d\w_])ext\((?=([^,]+?),([^)]+?)\))`|`\1jtext(jt,`|
|`jsrc\parsing\p.c`|ext|jtext|`(^\|[ \t]+\|[^\d\w_])ext\((?=([^,]+?),([^)]+?)\))`|`\1jtext(jt,`|
|`jsrc\verbs\vb.c`|ext|jtext|`(^\|[ \t]+\|[^\d\w_])ext\((?=([^,]+?),([^)]+?)\))`|`\1jtext(jt,`|
|`jsrc\verbs\vp.c`|ext|jtext|`(^\|[ \t]+\|[^\d\w_])ext\((?=([^,]+?),([^)]+?)\))`|`\1jtext(jt,`|
|`jsrc\verbs\vsb.c`|ext|jtext|`(^\|[ \t]+\|[^\d\w_])ext\((?=([^,]+?),([^)]+?)\))`|`\1jtext(jt,`|
|`jsrc\words\w.c`|ext|jtext|`(^\|[ \t]+\|[^\d\w_])ext\((?=([^,]+?),([^)]+?)\))`|`\1jtext(jt,`|
|`jsrc\words\wc.c`|ext|jtext|`(^\|[ \t]+\|[^\d\w_])ext\((?=([^,]+?),([^)]+?)\))`|`\1jtext(jt,`|
|`jsrc\xenos\x15.c`|ext|jtext|`(^\|[ \t]+\|[^\d\w_])ext\((?=([^,]+?),([^)]+?)\))`|`\1jtext(jt,`|
|`jsrc\xenos\xd.c`|ext|jtext|`(^\|[ \t]+\|[^\d\w_])ext\((?=([^,]+?),([^)]+?)\))`|`\1jtext(jt,`|
|`jsrc\xenos\xf.c`|ext|jtext|`(^\|[ \t]+\|[^\d\w_])ext\((?=([^,]+?),([^)]+?)\))`|`\1jtext(jt,`|
