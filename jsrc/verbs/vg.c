...
F2(jtgrade2 ){F2PREFIP;A z;GBEGIN(-1); RZ(z=SPARSE&AT(w)?grd2sp(a,w):jtgr2(jtinplace,a,w)); GEND
 RETF(z);}
F2(jtdgrade2){F2PREFIP;A z;GBEGIN( 1); RZ(z=SPARSE&AT(w)?grd2sp(a,w):jtgr2(jtinplace,a,w)); GEND
 RETF(z);}
