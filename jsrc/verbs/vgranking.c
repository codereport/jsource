...
// /:@/:
 A jtranking(J jt, A w){A y,z;C*wv;I icn,i,k,m,n,t,wcr,wf,wn,wr,*ws,wt,*zv;CR rng;TTYPE *yv,*yu;
 ...
 else{RE(m=jtprod(jt,wf,ws)); return m?jtreitem(jt,vec(INT,wf,ws),iota(v2(1L,n))):jtreshape(jt,vec(INT,1+wf,ws),num(0));}
