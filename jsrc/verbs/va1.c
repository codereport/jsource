...
// This entry point supports inplacing
 ...
 A jtpix   (J jt,    A w,A self){F1PREFIP; if(!w) return 0; if(XNUM&AT(w)&&(jt->xmode==XMFLR||jt->xmode==XMCEIL))return jtatomic1(jtinplace,w,self); return jtatomic2(jtinplace,pie,w,ds(CSTAR));}
