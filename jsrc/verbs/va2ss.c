...
A jtssingleton(J jt, A a,A w,A self,RANK2T awr,RANK2T ranks){A z;
 ...
 case SSINGCASE(VA2CPLUS-VA2CBW1111,SSINGBB): SSSTORENV(SSRDB(a)+SSRDB(w),z,INT,I) return z;  // NV because B01 is never virtual inplace
 ...
 case SSINGCASE(VA2CPLUS-VA2CBW1111,SSINGDD):
  {NAN0; SSSTORENVFL(SSRDD(a)+SSRDD(w),z,FL,D) NAN1; return z;}
 ...
 case SSINGCASE(VA2CSTAR-VA2CBW1111,SSINGID): {I av=SSRDI(a); SSSTORE(av?av*SSRDD(w):0.0,z,FL,D) return z;}
 case SSINGCASE(VA2CSTAR-VA2CBW1111,SSINGDI): {I wv=SSRDI(w); SSSTORE(wv?wv*SSRDD(a):0.0,z,FL,D) return z;}
 ...
 case SSINGCASE(VA2CDIV-VA2CBW1111,SSINGBB): {B av=SSRDB(a); B wv=SSRDB(w); SSSTORENV(wv?av:av?inf:0.0,z,FL,D) return z;}
 case SSINGCASE(VA2CDIV-VA2CBW1111,SSINGBD): {B av=SSRDB(a); D wv=SSRDD(w); SSSTORENV((av||wv)?av/(D)wv:0.0,z,FL,D) return z;}
 case SSINGCASE(VA2CDIV-VA2CBW1111,SSINGDB): {D av=SSRDD(a); B wv=SSRDB(w); SSSTORENV((av||wv)?av/(D)wv:0.0,z,FL,D) return z;}
 case SSINGCASE(VA2CDIV-VA2CBW1111,SSINGID): {I av=SSRDI(a); D wv=SSRDD(w); SSSTORE((av||wv)?av/(D)wv:0.0,z,FL,D) return z;}
 case SSINGCASE(VA2CDIV-VA2CBW1111,SSINGDI): {D av=SSRDD(a); I wv=SSRDI(w); SSSTORE((av||wv)?av/(D)wv:0.0,z,FL,D) return z;}
 case SSINGCASE(VA2CDIV-VA2CBW1111,SSINGBI): {B av=SSRDB(a); I wv=SSRDI(w); SSSTORE((av||wv)?av/(D)wv:0.0,z,FL,D) return z;}
 case SSINGCASE(VA2CDIV-VA2CBW1111,SSINGIB): {I av=SSRDI(a); B wv=SSRDB(w); SSSTORE((av||wv)?av/(D)wv:0.0,z,FL,D) return z;}
 case SSINGCASE(VA2CDIV-VA2CBW1111,SSINGII): {I av=SSRDI(a); I wv=SSRDI(w); SSSTORE((av||wv)?av/(D)wv:0.0,z,FL,D) return z;}
 case SSINGCASE(VA2CDIV-VA2CBW1111,SSINGDD): {NAN0; SSSTORENVFL(DIV(SSRDD(a),(D)SSRDD(w)),z,FL,D) NAN1; return z;}


 case SSINGCASE(VA2CPLUSDOT-VA2CBW1111,SSINGBB): {SSSTORENV(SSRDB(a)|SSRDB(w),z,B01,B) return z;}
 ...
 case SSINGCASE(VA2CSTARDOT-VA2CBW1111,SSINGBB): {SSSTORENV(SSRDB(a)&SSRDB(w),z,B01,B) return z;}
 ...
 case SSINGCASE(VA2CSTILE-VA2CBW1111,SSINGID): aiv=SSRDI(a); wdv=SSRDD(w);
   ziv=jtremid(jt,aiv,wdv); if(!jt->jerr){SSSTORE(ziv,z,INT,I);}else z=0; return z;  // Since this can retry, we must not modify the input block if there is an error
 ...
 case SSINGCASE(VA2CSTILE-VA2CBW1111,SSINGDD): adv=SSRDD(a); wdv=SSRDD(w);
  floatresidue: ;
   zdv=jtremdd(jt,adv,wdv); if(!jt->jerr){SSSTORE(zdv,z,FL,D);}else z=0; return z;  // Since this can retry, we must not modify the input block if there is an error
