...
A jtiovxs(J jt,I mode,A a,A w){A e,x,z;B h;I at,t,wt;P*ap=0,*wp,*zp;
 ...
 SPB(zp,a,SPA(wp,a));
 SPB(zp,i,SPA(wp,i));
 e=SPA(wp,e); if(h&&TYPESNE(t,wt))RZ(e=jtcvt(jt,t,e));
 x=SPA(wp,x); if(h&&TYPESNE(t,wt))RZ(x=jtcvt(jt,t,x));
...
static B jtioresparse(J jt,B aw,A*za,A*zw){A a,e,w;B*ab,ac=0,*wb,wc=0;I ar,j,wr;P*ap,*wp;
 ...
 if(aw){
  ...
  e=SPA(ap,e); if(!jtequ(jt,e,SPA(wp,e))){RZ(w=rezero(e,w)); wp=PAV(w);}
