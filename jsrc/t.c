...
PRIM primtab[256] = {
 ...
 /*  |. */  PRIMACV(CREV,    VERB, jtreverse, jtrotate, RMAX,1,   RMAX,VASGSAFE|VIRS1|VIRS2|VJTFLGOK1|VJTFLGOK2,VF2NONE),   // alias CROT
 ...
 /*  [  */  PRIMACV(CLEFT,   VERB, same,  jtleft2,  RMAX,RMAX,RMAX,VASGSAFE|VIRS1|VIRS2|VISATOMIC1|VJTFLGOK1|VJTFLGOK2,VF2NONE),
 ...
 /*  ]  */  PRIMACV(CRIGHT,  VERB, same,  jtright2, RMAX,RMAX,RMAX,VASGSAFE|VIRS1|VIRS2|VISATOMIC1|VJTFLGOK1|VJTFLGOK2,VF2NONE),
