...
#define PRIMNOUN(id, t, an, ar, val) \
    [id] = {{AKXR(ar), (t)&TRAVERSIBLE, 0, (t), ACPERMANENT, (an), (ar)}, {.primint = val}}
#define PRIMALL(id, t, f0, f1, f, g, h, initpm1, initpm2, rm, rl, rr, vflg, vflg2, an, ar, lc) \
    [id] = {                                                                                   \
      {AKXR(ar), (t)&TRAVERSIBLE, 0, (t), ACPERMANENT, (an), (ar)},                            \
      {{{f0, f1}, {f, g, h}, {initpm1, initpm2}, (vflg), (vflg2), (RANK2T)((rl << RANKTX) + rr), (RANKT)rm, id, lc}}}
#define PRIMACV(id, t, f0, f1, rm, rl, rr, vflg, vflg2) \
    PRIMALL(id, t, f0, f1, 0, 0, 0, .lfns = (AF)0, (AF)0, rm, rl, rr, vflg, vflg2, (VERBSIZE + SZI - 1) >> LGSZI, 0, 0)
#define PRIMACVPARM(id, t, f0, f1, rm, rl, rr, vflg, vflg2, initpm1, initpm2) \
    PRIMALL(id, t, f0, f1, 0, 0, 0, initpm1, initpm2, rm, rl, rr, vflg, vflg2, (VERBSIZE + SZI - 1) >> LGSZI, 0, 0)
#define PRIMATOMIC2(id, t, f0, f1, rm, rl, rr, vflg, vflg2) \
    PRIMALL(id,                                             \
            t,                                              \
            f0,                                             \
            f1,                                             \
            ...
            VISATOMIC2 | (vflg),                            \
            vflg2,                                          \
            (VERBSIZE + SZI - 1) >> LGSZI,                  \
            0,                                              \
            VA2##id + 0x80 * (id == CLT || id == CGT || id == CLE || id == CGE || id == CEQ || id == CNE))
#define PRIMATOMIC2g(id, t, f0, f1, rm, rl, rr, vflg, vflg2, g) \
    PRIMALL(id,                                                 \
            t,                                                  \
            f0,                                                 \
            f1,                                                 \
            ...
            0,                                                  \
            VA2##id + 0x80 * (id == CLT || id == CGT || id == CLE || id == CGE || id == CEQ || id == CNE))
#define PRIMATOMIC1(id, t, f0, f1, rm, rl, rr, vflg, vflg2) \
    PRIMALL(id,                                             \
            t,                                              \
            f0,                                             \
            f1,                                             \
...
#define PRIMATOMIC12(id, t, f0, f1, rm, rl, rr, vflg, vflg2) \
    PRIMALL(id,                                              \
            t,                                               \
            f0,                                              \
            f1,                                              \
...
PRIM primtab[256] = {
  ...
  PRIMATOMIC2(CBW0000,
              ...
              0,
              0,
              VISATOMIC1 | VFUSEDOK2 | VIRS2 | VASGSAFE | VJTFLGOK1 | VJTFLGOK2,
              VF2NONE),
  /*  bw */
  PRIMATOMIC2(CBW0001,
              VERB,
  ...
  PRIMATOMIC2g(CLT,
               ...
               0,
               0,
               VASGSAFE | VFUSEDOK2 | VIRS1 | VIRS2 | VJTFLGOK1 | VJTFLGOK2,
               VF2BOXATOP1,
               ds(CRIGHT)),  // alias CLT
                             /*  <. */
  PRIMATOMIC12(CMIN,
  ...
  /*  >  */
  PRIMATOMIC2(
    CGT, VERB, jtope, jtatomic2, 0, 0, 0, VFUSEDOK2 | VASGSAFE | VIRS2 | VJTFLGOK2, VF2WILLOPEN1),  // alias CGT
                                                                                                    /*  >. */
  PRIMATOMIC12(CMAX,
               VERB,
               jtatomic1,
  ...
  /*  +. */
  PRIMATOMIC2(
    CPLUSDOT, VERB, jtrect, jtatomic2, 0, 0, 0, VISATOMIC1 | VFUSEDOK2 | VIRS2 | VASGSAFE | VJTFLGOK2, VF2NONE),
  /*  +: */
  PRIMATOMIC2(CPLUSCO,
              VERB,
              jtduble,
  ...
  /*  *. */
  PRIMATOMIC2(
    CSTARDOT, VERB, jtpolar, jtatomic2, 0, 0, 0, VISATOMIC1 | VFUSEDOK2 | VIRS2 | VASGSAFE | VJTFLGOK2, VF2NONE),
  /*  *: */
  PRIMATOMIC2(CSTARCO,
              VERB,
              jtsquare,
  ...
  /*  -: */
  PRIMACV(
    CHALVE, VERB, jthalve, jtmatch, 0, RMAX, RMAX, VISATOMIC1 | VIRS2 | VASGSAFE | VJTFLGOK1, VF2NONE),  // alias CMATCH
                                                                                                         /*  %  */
  PRIMATOMIC2(CDIV,
              VERB,
              jtrecip,
  ...
  /*  $  */ PRIMACV(CDOLLAR, VERB, shape, jtreitem, RMAX, 1, RMAX, VASGSAFE | VIRS2 | VJTFLGOK2, VF2NONE),
  ...
  PRIMACV(CREV,
          ...
          1,
          RMAX,
          VASGSAFE | VIRS1 | VIRS2 | VJTFLGOK1 | VJTFLGOK2,
          VF2NONE),  // alias CROT
                     /*  |: */
  PRIMACV(CCANT, VERB, jtcant1, jtcant2, RMAX, 1, RMAX, VASGSAFE | VIRS1 | VIRS2 | VJTFLGOK1 | VJTFLGOK2, VF2NONE),
  ...
  /*  ;: */ PRIMACVPARM(CWORDS, VERB, jtwords, jtfsm, 1, RMAX, RMAX, VASGSAFE, VF2NONE, .lpf = 0, 0),  // parms are
                                                                                                       // passed through
                                                                                                       // to jtboxcut0
  /*  #  */ PRIMACV(CPOUND, VERB, tally, jtrepeat, RMAX, 1, RMAX, VASGSAFE | VIRS2 | VJTFLGOK2, VF2NONE),
  ...
  PRIMACV(CLEFT,
          ...
          RMAX,
          RMAX,
          VASGSAFE | VIRS1 | VIRS2 | VISATOMIC1 | VJTFLGOK1 | VJTFLGOK2,
          VF2NONE),
  /*  [: */ PRIMACV(CCAP, VERB, jtdomainerr1, jtdomainerr2, RMAX, RMAX, RMAX, VFLAGNONE, VF2NONE),  // not ASGSAFE since
                                                                                                    // used for
                                                                                                    // not-yet-defined
                                                                                                    // names
                                                                                                    /*  ]  */
  ...
  /*  {. */
  PRIMACV(
    CHEAD, VERB, jthead, jttake, RMAX, 1, RMAX, VASGSAFE | VIRS1 | VIRS2 | VJTFLGOK1 | VJTFLGOK2, VF2NONE),  // alias
                                                                                                             // CTAKE
  ...
  /*  }* */ PRIMACV(CCASEV, VERB, jtcasev, jtdomainerr2, RMAX, RMAX, RMAX, VFLAGNONE, VF2NONE),  // f2 gets filled in
                                                                                                 // with pointer to a
                                                                                                 // name when this is
                                                                                                 // used
                                                                                                 /*  }. */
...
B
jtpinit(J jt) {
    AS((A)&primtab[CALP])[0] = NALP;
    AK((A)&primtab[CALP])    = (I)alp - (I)&primtab[CALP];
    return 1;
}
