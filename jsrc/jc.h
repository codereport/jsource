...
// if code&~CA==0 (i. e. bits 0 & 3 clear), the value is a letter if code&~(CA|C9) (i. e. bit 0 set), it is not
// alphameric
#define CX 11 /* other                                   */
...
#define CQ 15 /* quote                                   */
#define CU \
    12  // like CX, but uninflectable.  Used for DDSEP.  it doesn't follow the alphanumeric rules so mustn't be a valid
        // word for parse
#define CDD 5   // DDBGN {
#define CDDZ 9  // DDEND }
